namespace SRTPluginProviderDR1.Structs
{
    public enum ItemEnumeration : uint
    {
        ...
        M1851WolfsbaneIncreasedCapacityCylinder = 0x34677B7B,
        M1851WolfsbaneLongBarrelMod = 0x3799AE6C,
        M1897HairTrigger = 0xE1C3FD10,
        M1897MrRaccoon = 0x8DC6F981,
        M1911HighCapacityMag = 0x367676E9,
        M1911ImprovedGrip = 0x4D359D1,
        Mine = 0xBF8C9893,
        PipeBomb = 0x3E2472F8,
        STAKEHighCapacityMag = 0xC5506692,
        STAKEImprovedGrip = 0xC5BBF16C,
        SYG12DrumMagazine = 0x9E650FE4,
        SYG12LongBarrel = 0x0E8CA5DB,
        SYG12RedDotSight = 0x483E773C,
        V61CustomDrumMagazine = 0xEA718813,
        V61CustomGunstock = 0x95113862,
        V61CustomLongBarrel = 0x9E29A77D,
        W870TACForegrip = 0x7FCFE664,
        W870TACImprovedGunstock = 0xBC09B92C,
        WCXForegrip = 0x09C0D382,
        WCXRedDotSight = 0x1F229090,
